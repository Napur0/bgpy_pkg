...
class RSABGPiSecCryptTransitive(BGPiSecCryptTransitive):
    """Represents BGPiSec Transitive attributes"""

    name = "BGP-iSec Crypt Transitive Only with RSA"
    ...
    def _policy_propagate(
        ...
        send_ann = ann.copy({"bgpsec_next_asn": neighbor.asn, "bgpsec_as_path": ann.bgpsec_as_path, "bgpsec_signatures": sig_list})
